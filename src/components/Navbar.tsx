  ...
  return (
    ...
    >
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop flex justify-between items-center h-full">
        <div className="text-headline-md font-headline-md font-bold tracking-tighter text-on-surface">
          AMAN.SAHU
        </div>
        <div className="hidden md:flex gap-8 items-center">
          ...
          <button className="ml-4 primary-glow-btn text-on-primary px-6 py-2.5 rounded-full font-label-caps text-label-caps uppercase font-bold transition-all duration-300">
            Let's Talk
          </button>
        </div>
        {/* Mobile Menu Toggle */}
